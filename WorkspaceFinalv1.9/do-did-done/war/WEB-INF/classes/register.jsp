...
%>   
   ...
   <div class="w3-container w3-center">
	<form method="post" action="/userRegister" style="width:33%; display:inline-block; text-align: center;">
		...
		<input class="w3-input" type="text" name="email" placeholder="Email Id" 
				pattern = "^[_A-Za-z0-9\.]{4,}(@)[A-Za-z]{4,10}(\.)[A-Za-z]{2,8}$"	required/><br />
		<input class="w3-input" type="text" name="phone" placeholder="Contact Number" pattern="^[0-9]{10}$"required/><br />
